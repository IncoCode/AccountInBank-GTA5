...
namespace Tests
{
    ...
    public class GTADateTest
    {
        ...
        {
            var date1 = new GTADate( 2015, 11, 20 );
            var date2 = new GTADate( 2015, 11, 21 );
        ...
        {
            var date1 = new GTADate( 2015, 11, 21 );
            var date2 = new GTADate( 2015, 11, 20 );
        ...
        {
            var date1 = new GTADate( 2015, 11, 19 );
            var date2 = new GTADate( 2015, 10, 20 );
            Assert.IsTrue( date1 > date2 );
        }
        ...
        {
            var date1 = new GTADate( 2016, 11, 19 );
            var date2 = new GTADate( 2015, 11, 19 );
            Assert.IsTrue( date1 > date2 );
        }
        ...
        {
            var date2 = new GTADate( 2015, 11, 19 );
            var date1 = new GTADate( 2015, 10, 20 );
            Assert.IsTrue( date1 < date2 );
        }
        ...
        {
            var date2 = new GTADate( 2016, 11, 19 );
            var date1 = new GTADate( 2015, 11, 19 );
            Assert.IsTrue( date1 < date2 );
        }
        ...
        public void RightMoreEqualsDay()
        {
            var date1 = new GTADate( 2015, 11, 21 );
            var date2 = new GTADate( 2015, 11, 20 );
            var date3 = new GTADate( 2015, 11, 20 );
            var date4 = new GTADate( 2015, 11, 20 );
